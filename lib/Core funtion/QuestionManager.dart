...
class QuestionManager {
  ...
  Future<list_sort> getListSortData(String idCauHoi) async {
    try {
      return await list_sort.getListSortById(idCauHoi);
    } catch (e) {
      print('Error getting list_sort data: $e');
      return list_sort(
        Id: '',
        Answer: [],
        CorrectAnswer: '',
  ...
  Future<void> transferData() async {
    ...
    for (var chiTiet in chiTietList) {
      ...
      } else if (chiTiet.Type_cau_hoi == 'sort') {
        String idCauHoi = chiTiet.Id_cau_hoi;
        futures.add(() async {
          list_sort sortData = await getListSortData(idCauHoi);
          Map<String, dynamic> listquestions = {
            'type': 'sort',
            'question': sortData.Question,
            'answers': sortData.Answer,
            'correctAnswer': sortData.CorrectAnswer,
            'Id': idCauHoi,
          };
          questions.add(listquestions);
        }());
